...
public class HealthParameters : MonoBehaviour
{
    ...
    public HealthParametersFeedback GetHealthParametersFeedback()
    {
        ...
        return new HealthParametersFeedback(health * globalMultiplier, healthRegeneration, healthRegenerationCurve);
    }
...
public class HealthParametersFeedback
{
    ...
    public HealthParametersFeedback(float health, float healthRegeneration, AnimationCurve regenerationCurve)
    {
        this.health = health;
